    ...
    try {
        ...
        if (!name || rawPhone.length < 9) {
            return new Response(JSON.stringify({
                success: false,
                message: 'Vui lòng cung cấp Họ tên và Số điện thoại hợp lệ.'
            }), {
                status: 400,
